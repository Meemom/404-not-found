...
export function PerceptionNode({ data, id }: PerceptionNodeProps) {
  const healthColor =
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        whileTap={{ scale: 0.95 }}
        className="relative w-20 h-20 rounded-xl bg-gradient-to-br from-purple-900 to-purple-800 border-2 border-purple-400 shadow-lg flex items-center justify-center group hover:shadow-xl transition-shadow"
      ...
      >
        ...
        <motion.div
          ...
          className="absolute"
        >
          <Eye size={24} style={{ color: healthColor }} />
        </motion.div>
