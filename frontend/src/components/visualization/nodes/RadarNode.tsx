...
export function RadarNode({ data, id }: RadarNodeProps) {
  const healthColor =
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        whileTap={{ scale: 0.95 }}
        className="relative w-20 h-20 rounded-xl bg-gradient-to-br from-pink-900 to-pink-800 border-2 border-pink-400 shadow-lg flex items-center justify-center group hover:shadow-xl transition-shadow"
      ...
      >
        ...
        >
          <Radar size={24} style={{ color: healthColor }} />
        </motion.div>
