...
export function RiskNode({ data, id }: RiskNodeProps) {
  const healthColor =
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        whileTap={{ scale: 0.95 }}
        className="relative w-20 h-20 rounded-xl bg-gradient-to-br from-red-900 to-red-800 border-2 border-red-400 shadow-lg flex items-center justify-center group hover:shadow-xl transition-shadow"
      ...
      >
        ...
        >
          <AlertTriangle size={24} style={{ color: healthColor }} />
        </motion.div>
