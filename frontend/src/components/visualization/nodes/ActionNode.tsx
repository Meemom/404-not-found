  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        whileTap={{ scale: 0.95 }}
        className="relative w-20 h-20 rounded-xl bg-gradient-to-br from-green-900 to-green-800 border-2 border-green-400 shadow-lg flex items-center justify-center group hover:shadow-xl transition-shadow"
      ...
      >
        ...
        >
          <Send size={24} style={{ color: healthColor }} />
        </motion.div>
