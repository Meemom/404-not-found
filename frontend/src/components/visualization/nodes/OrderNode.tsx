  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        whileTap={{ scale: 0.95 }}
        className="relative w-20 h-20 rounded-xl bg-gradient-to-br from-indigo-900 to-indigo-800 border-2 border-indigo-400 shadow-lg flex items-center justify-center group hover:shadow-xl transition-shadow"
      ...
      >
        ...
        >
          <ShoppingCart size={24} style={{ color: healthColor }} />
        </motion.div>
