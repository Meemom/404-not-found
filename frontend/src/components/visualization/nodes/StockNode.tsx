...
export function StockNode({ data, id }: StockNodeProps) {
  const healthColor =
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        whileTap={{ scale: 0.95 }}
        className="relative w-20 h-20 rounded-xl bg-gradient-to-br from-amber-900 to-amber-800 border-2 border-amber-400 shadow-lg flex items-center justify-center group hover:shadow-xl transition-shadow"
      ...
      >
        ...
        >
          <Package size={24} style={{ color: healthColor }} />
        </motion.div>
